...
# Template: app
# Command: /Users/ciccio/Qt/5.4/clang_64/bin/qmake -spec macx-clang-omp CONFIG+=debug CONFIG+=x86_64 -o Makefile TetraMesh.pro
#############################################################################
...
CXXFLAGS      = -stdlib=libc++ -fpermissive -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk -std=c++0x -mmacosx-version-min=10.10 $(DEFINES)
...
Makefile: TetraMesh.pro ../../../../Qt/5.4/clang_64/mkspecs/macx-clang-omp/qmake.conf ../../../../Qt/5.4/clang_64/mkspecs/features/spec_pre.prf \
		...
		../../../../Qt/5.4/clang_64/mkspecs/features/lex.prf \
		TetraMesh.pro
	$(QMAKE) -spec macx-clang-omp CONFIG+=debug CONFIG+=x86_64 -o Makefile TetraMesh.pro
